    ...
    <SiteLayout>
      ...
      <section className="container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="mt-8 rounded-xl border border-primary/30 bg-blood p-8 text-center">
          ...
          <a href={settings.discord_url} target="_blank" rel="noreferrer"><Button size="lg" variant="secondary" className="mt-4"><MessageSquare className="mr-2 h-4 w-4" /> Join Discord</Button></a>
        </div>
      </section>
    </SiteLayout>
  );
