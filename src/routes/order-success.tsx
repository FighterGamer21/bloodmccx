      ...
      <section className="container mx-auto px-4 py-20 max-w-2xl text-center">
        ...
        <div className="mt-8 rounded-xl border border-primary/30 bg-primary/10 p-6 text-left">
          ...
          <ol className="mt-3 space-y-2 text-sm list-decimal list-inside">
            <li>Pay via UPI to <span className="font-mono">shadowroni@ybl</span> (INR).</li>
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-3">
          <a href="https://discord.gg/kUZjRQsxtm" target="_blank" rel="noreferrer"><Button size="lg" className="bg-blood shadow-blood"><MessageSquare className="mr-2 h-4 w-4" /> Open Discord Ticket</Button></a>
